...
I have just done a basic transfer of the actual Salesforce bits into here as we do not need the generator.
Eventually a more automated process should be implemented so that grabbing upstream changes is simply a matter of looking at a diff rather than a bunch of SFDX commands.
